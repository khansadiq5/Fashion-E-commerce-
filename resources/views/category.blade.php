    ...
    <main class="flex-1 min-w-0">
        ...
        <header class="h-16 border-b border-black/10 flex items-center justify-between px-5 md:px-10 bg-[#f6f1ea]/90 backdrop-blur-md sticky top-0 z-30">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-light">Categories</h2>
                    <p class="text-xs text-gray-500">Manage product categories</p>
                </div>
            </div>
        ...
        <div class="p-5 md:p-8">
            ...
            <div class="flex flex-col xl:flex-row xl:justify-between xl:items-end gap-5 mb-6">
                <div>
                    ...
                    <h1 class="text-3xl md:text-4xl font-light">Category List</h1>
                    <p class="mt-2 text-sm text-gray-500">
                        Organize your store products into clean and manageable categories.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
                <div class="bg-white rounded-2xl border border-black/5 px-5 py-4 shadow-sm">
                    <p class="text-xs uppercase tracking-[0.2em] text-gray-500">Total Categories</p>
                    <h3 class="mt-2 text-2xl font-semibold">{{ $categories->total() ?? $categories->count() }}</h3>
                </div>

                <div class="bg-white rounded-2xl border border-black/5 px-5 py-4 shadow-sm">
                    <p class="text-xs uppercase tracking-[0.2em] text-gray-500">Showing</p>
                    <h3 class="mt-2 text-2xl font-semibold">{{ $categories->count() }}</h3>
                </div>

                <div class="bg-white rounded-2xl border border-black/5 px-5 py-4 shadow-sm">
                    <p class="text-xs uppercase tracking-[0.2em] text-gray-500">Current Page</p>
                    <h3 class="mt-2 text-2xl font-semibold">{{ method_exists($categories, 'currentPage') ? $categories->currentPage() : 1 }}</h3>
                </div>
                ...
                <div class="bg-black text-white rounded-2xl border border-black px-5 py-4 shadow-sm">
                    ...
                    <h3 class="mt-2 text-2xl font-semibold">Categories</h3>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-black/5 overflow-hidden shadow-sm">
                ...
                <div class="px-6 py-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Category name, slug, description, status and actions.</p>
                    </div>

                    <a href="{{ url('admin/category') }}" class="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full border border-gray-200 text-sm hover:bg-black hover:text-white hover:border-black transition">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left min-w-[900px]">
                        ...
                        <thead class="bg-black text-white">
                            <tr>
                                <th class="px-6 py-4 text-xs uppercase tracking-[0.18em] font-normal">ID</th>
                                <th class="px-6 py-4 text-xs uppercase tracking-[0.18em] font-normal">Name</th>
                                <th class="px-6 py-4 text-xs uppercase tracking-[0.18em] font-normal">Slug</th>
                                ...
                                <tr class="hover:bg-[#faf7f2] transition">
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-xl bg-[#f6f1ea] border border-black/5 flex items-center justify-center text-sm font-semibold">
                                                {{ strtoupper(substr($cat->name ?? 'C', 0, 1)) }}
                                            </div>
                                    ...
                                    <td colspan="6" class="px-6 py-16 text-center">
                                        <div class="max-w-md mx-auto">
                                            ...
                                            <p class="text-sm text-gray-500 mt-2">
                                                Add your first category to organize your Viora products.
                                            </p>
