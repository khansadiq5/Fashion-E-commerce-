...
<head>
    ...
    <title>Viora | Edit Category</title>
    ...
    <main class="flex-1 min-w-0">
        ...
        <header class="h-16 border-b border-black/10 flex items-center justify-between px-5 md:px-10 bg-[#f6f1ea]/90 backdrop-blur-md sticky top-0 z-30">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-light">Edit Category</h2>
                    <p class="text-xs text-gray-500">Update category information</p>
                </div>
            </div>
        ...
        <div class="p-5 md:p-8">
            ...
            <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5 mb-6">
                <div>
                    ...
                    <h1 class="text-3xl md:text-4xl font-light">Edit Category</h1>
                    <p class="mt-2 text-sm text-gray-500 max-w-2xl">
                        Update category name, description and visibility status for your Viora store.
                    </p>
                </div>

                <div class="bg-black text-white rounded-2xl px-5 py-4 w-full sm:w-fit">
                    <p class="text-xs uppercase tracking-[0.2em] text-white/50">Category ID</p>
                    <h3 class="mt-1 text-xl font-semibold">#{{ $category->id }}</h3>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-2xl border border-black/5 p-6 md:p-8 shadow-sm">
                            <div class="mb-7">
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    Keep category name clear so products are easy to browse on user side.
                                </p>
                            </div>
                        ...
                        <div class="bg-white rounded-2xl border border-black/5 p-6 md:p-8 shadow-sm">
                            <div class="mb-7">
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    Active categories can be shown on the customer side and product forms.
                                </p>
                            </div>
                    ...
                    <aside class="space-y-6 xl:sticky xl:top-24">
                        ...
                        <div class="bg-[#111111] text-white rounded-2xl p-6 shadow-sm">
                            ...
                            <p class="text-sm text-white/60 leading-6 mb-6">
                                Changes will update this category across admin panel and product category selection.
                            </p>
                        ...
                        <div class="bg-white rounded-2xl border border-black/5 p-6 shadow-sm">
                            ...
                            <p class="text-sm text-gray-600 leading-6">
                                Avoid changing category names too often if products are already assigned to this category.
                            </p>
                        </div>
